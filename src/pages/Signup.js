    ...
    <section className="flex flex-col justify-center items-center py-5 gap-2 bg-[#fafafa]">
      <div className="border flex flex-col items-center px-3 pb-6">
        ...
        <div className="flex flex-col px-6 gap-4 pb-3">
          <h2 className="flex  flex-col items-center text-gray-500 text-md font-semibold  ">
          ...
          <div className="flex flex-col ">
            <form action="" className="flex flex-col gap-2">
              <input
                ...
                className=" outline-none py-2 px-3  text-[12px] bg-zinc-100  text-gray-900 border focus:border-zinc-600 border-gray-300"
              />
              <input
                type="text"
          ...
          <button
            type="submit"
            className="bg-[#0095f6] rounded-lg text-sm py-1.5 text-white font-semibold cursor-pointer"
          >
            Sign Up
          </button>
        </div>
      ...
      <div className="border flex  justify-center py-5 px-[107px] gap-1 text-sm ">
        ...
        <span className="text-[hsl(204,49%,71%)] font-semibold  cursor-pointer">
          <Link to="/">Log in</Link>
        </span>
      </div>
